...
const LayoutComponent = ({children, curWindow}) => {
  ...
  return (
    <div className='w-full h-full flex bg-gray-300'>
        {/* Left Panel */}
      <div className='w-1/6 h-full bg-black p-3 pt-8 text-white flex flex-col justify-between'>
          ...
          <div className='flex flex-col justify-between'>
            <div className='pl-2 space-y-4 text-lg'>
        ...
        <div className=' flex items-center justify-center text-sm pb-10'>Data provided by The New York Times</div>
